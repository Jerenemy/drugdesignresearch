...
class GraphDataLoader2():
    ...
    def GetValidation(self, size):
        batches = []
        for i in range(0, len(self.test_ids)-size, size): # for i in range(size)
...
class SupervisedTrainingWrapper():
    ...
    def Train(self, num_epochs):
        ...
        for i in (range(num_epochs)):
            ...
            for step in tqdm(range(steps_per_epoch)): # NOTE what is this? how can you iterate over tqdm. what is tqdm.
                self._train()
